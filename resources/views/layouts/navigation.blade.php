    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @auth
                    <!-- Si el usuario puede crear vacantes, entonces se le mostrarán estos enlaces, sino NO -->
            ...
            <!-- Si el usuario puede crear vacantes, es porque es un reclutador, entonces podrá leer sus notificaciones -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <p class="text-base font-medium text-gray-600">
                @choice('Notificaciones|Notificaciones', auth()->user()->unreadNotifications->count()) 
            </p>
            </div>
        @endif
        </div>
